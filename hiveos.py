...
def hiveos_requests():
    ...
    def worker_1():
        ...
        worker_1_gpu_0_hashrate = hiveos_api_keys["gpu_stats"][0]["hash"]
        worker_1_gpu_0_power = str(hiveos_api_keys["gpu_stats"][0]["power"]) + " W"
        worker_1_gpu_0_fan = str(hiveos_api_keys["gpu_stats"][0]["fan"]) + " %"
        worker_1_gpu_0_coretemp = str(hiveos_api_keys["gpu_stats"][0]["temp"]) + " °C"
        worker_1_gpu_0_memtemp = str(hiveos_api_keys["gpu_stats"][0]["memtemp"]) + " °C"
        ...
        worker_1_gpu_1_hashrate = hiveos_api_keys["gpu_stats"][1]["hash"]
        worker_1_gpu_1_power = str(hiveos_api_keys["gpu_stats"][1]["power"]) + " W"
        worker_1_gpu_1_fan = str(hiveos_api_keys["gpu_stats"][1]["fan"]) + " %"
        worker_1_gpu_1_coretemp = str(hiveos_api_keys["gpu_stats"][1]["temp"]) + " °C"
        worker_1_gpu_1_memtemp = str(hiveos_api_keys["gpu_stats"][1]["memtemp"]) + " °C"
        ...
        worker_1_gpu_2_hashrate = hiveos_api_keys["gpu_stats"][2]["hash"]
        worker_1_gpu_2_power = str(hiveos_api_keys["gpu_stats"][2]["power"]) + " W"
        worker_1_gpu_2_fan = str(hiveos_api_keys["gpu_stats"][2]["fan"]) + " %"
        worker_1_gpu_2_coretemp = str(hiveos_api_keys["gpu_stats"][2]["temp"]) + " °C"
        worker_1_gpu_2_memtemp = str(hiveos_api_keys["gpu_stats"][2]["memtemp"]) + " °C"
        ...
        worker_1_gpu_3_hashrate = hiveos_api_keys["gpu_stats"][3]["hash"]
        worker_1_gpu_3_power = str(hiveos_api_keys["gpu_stats"][3]["power"]) + " W"
        worker_1_gpu_3_fan = str(hiveos_api_keys["gpu_stats"][3]["fan"]) + " %"
        worker_1_gpu_3_coretemp = str(hiveos_api_keys["gpu_stats"][3]["temp"]) + " °C"
        worker_1_gpu_3_memtemp = str(hiveos_api_keys["gpu_stats"][3]["memtemp"]) + " °C"
